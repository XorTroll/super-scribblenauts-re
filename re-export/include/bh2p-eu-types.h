...
enum StructOA_MaskX {
    ...
    StructOA_MaskX_Unk3_IsBackground = 8,
    StructOA_MaskX_Unk4 = 16,
    StructOA_MaskX_Unk6 = 64,
};
...
enum StructOOO_MaskA {
    ...
    StructOOO_MaskA_OnGround = 2,
    StructOOO_MaskA_TouchGrabbed = 128,
    StructOOO_MaskA_Unk8 = 256,
    StructOOO_MaskA_Unk10_MaybeFree = 1024,
    StructOOO_MaskA_Unk20 = 1048576,
};

enum StructOD_MaskE {
    StructOD_MaskE_None = 0,
    StructOD_MaskE_Unk2 = 4,
};

enum PlayMode {
    PlayMode_LevelOrCredits = 0,
    PlayMode_Tutorial = 1,
    PlayMode_CustomLevel = 3,
    PlayMode_Playground = 7,
};
...
typedef struct C_ScribbleAdjectiveMod C_ScribbleAdjectiveMod;
...
typedef struct StructST StructST;

typedef struct StructUV StructUV;

typedef struct StructUVEntry StructUVEntry;

typedef struct StructOASub StructOASub;
...
struct StructOF {
    ...
    /* off 0xC size 0x2 */
    u16 obj_file_unk8_maybe_cost;

    /* off 0xE size 0x1 */
    u8 os32227_maybe_coolness;
...
_Static_assert(sizeof(StructBB1) == 0x10, "StructBB1 definition");
...
_Static_assert(sizeof(StructST) == 0x824, "StructST definition");

/* size 0xC */
struct StructUV {
    /* off 0x0 size 0x4 */
    StructUVEntry *entries_ptr;
...
_Static_assert(sizeof(StructUV) == 0xC, "StructUV definition");

/* size 0x8 */
struct StructUVEntry {
    /* off 0x0 size 0x4 */
    u32 ptr_slot_idx;
...
_Static_assert(sizeof(StructUVEntry) == 0x8, "StructUVEntry definition");
...
_Static_assert(sizeof(StructOASub) == 0xC, "StructOASub definition");
...
_Static_assert(sizeof(C_ScribbleAdjectiveMod) == 0x1B4, "C_ScribbleAdjectiveMod definition");
...
struct StructOA {
    ...
    /* off 0x1E size 0x1 */
    u8 oa721_maybe_sprite_dim;

    /* off 0x1F size 0x1 */
    u8 oa722_maybe_sprite_dim;
    ...
    /* off 0x34 size 0x4 */
    StructOSubSubSub *subsubsub_ref;
...
struct StructOI {
    ...
    /* off 0xAC size 0x4 */
    StructOSubSubSub *obj_subsubsub;
...
struct StructOOO {
    ...
    /* off 0x30 size 0x4 */
    fx32 obj_apply_x_accel;

    /* off 0x34 size 0x4 */
    u32 obj_apply_y_accel;

    /* off 0x38 size 0x4 */
    fx32 obj_x_unk_accel;

    /* off 0x3C size 0x4 */
    fx32 obj_y_unk_accel;
...
struct Object {
    ...
    C_ScribbleAdjectiveMod adj_holder;
    ...
    /* off 0x540 size 0x2 */
    u16 like_unk16_4_maybe_sprite_dim;

    /* off 0x542 size 0x2 */
    u16 like_unk16_5_maybe_sprite_dim;
